It is a transaction submitted by the initial proposer, or the current holder of the [[proposal_x_Claim|proposal_x_Claim]] NFT, to withdraw money from the treasury of the [[unLearn|unLearn]] instance.
